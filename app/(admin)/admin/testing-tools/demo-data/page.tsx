...
export default function AdminDemoDataPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* App Store Screenshots Link */}
      <a
        href="/admin/screenshots"
        className="block bg-orange-50 border border-orange-200 rounded-lg p-4 hover:bg-orange-100/70 transition-colors"
      >
        <div className="flex items-center gap-3">
          <div className="text-orange-500 text-xl">📸</div>
          <div className="flex-1">
            <h3 className="text-sm font-semibold text-orange-900">App Store Screenshots</h3>
